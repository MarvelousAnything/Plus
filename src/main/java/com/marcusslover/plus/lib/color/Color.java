...
public class Color {
  ...
  /**
   * You will need to use {@link Component#text(String)}.color(color.adventure())
   * and then serialize it {@link LegacyComponentSerializer#legacySection()}
   *
   ...
   * <b>Note that this pretty much only works with
   * {@link Player#sendMessage(String)}</b>
   *
   ...
   * Take in mind, this function does not change values of the original color
   * instance.
